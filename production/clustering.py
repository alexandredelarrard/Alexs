...
class ClusteringArticles(object):
    ...
    def main_article_clustering(self):
        self.clean_articles()
        self.articles = self.clustering_Tf_Itf()
    ...
    def tokenize(self, text):
        ...
        tokens = [self.lemmetizer.lemmatize(word) for word in tokens]
        return tokens
...
#        feature_names = tfidf.get_feature_names()
    ...
    def load_doc2vec_model(self):
        fname = get_tmpfile(os.paht["DIR_PATH"] + "/script/clustering/doc2vec_articles_181022")
