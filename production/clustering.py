...
class ClusteringArticles(object):
    ...
    def clustering_Tf_Itf(self):
        ...
        tfidf = TfidfVectorizer(tokenizer=self.tokenize, stop_words=liste_french, ngram_range=(1,4), 
                               max_features = 20000)
    ...
    def load_doc2vec_model(self):
        fname = get_tmpfile(os.paht["DIR_PATH"] + "/data/doc2vec/v2/doc2vec_articles_181030")
